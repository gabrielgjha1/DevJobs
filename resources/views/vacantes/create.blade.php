...
@section('content')
    ...
    <h1 class="text-2xl text-center mt-10 hola" >Nueva vacantes</h1>

    <form
        action="{{route('vacante.store')}}" method="POST"
        ...
        <div class="mb-5">
            ...
            <input id="titulo"  type="text" class="p-3 bg-gray-100 border-solid bordes border rounded form-input w-full " placeholder="Ingrese un titulo" name="titulo" >
        ...
        <div class="mb-5">
            ...
            <option selected disabled>- Selecciona -</option>
                ...
                @foreach ($ubicaciones as $item)
                    ...
                    <option {{old('experiencia')==$item->id ? 'selected': ''   }} value="{{$item->id}}">
                        {{$item->nombre}}
                    </option>
        ...
        <div class="mb-5">
            ...
            <option selected disabled>- Selecciona -</option>
                ...
                @foreach ($salarios as $item)
                    ...
                    <option {{old('salarios')==$item->id ? 'selected': ''   }} value="{{$item->id}}">
                        {{$item->nombre}}
                    </option>
